...
public:
        ...
        : Node("point_cloud_registering")
    {
        ...
        pcl::PointCloud<pcl::PointXYZRGB>::Ptr pcl1_colored(new pcl::PointCloud<pcl::PointXYZRGB>);
        pcl::PointCloud<pcl::PointXYZRGB>::Ptr pcl2_colored(new pcl::PointCloud<pcl::PointXYZRGB>);
        pcl::PointCloud<pcl::PointXYZRGB>::Ptr align_colored(new pcl::PointCloud<pcl::PointXYZRGB>);
        colorize(*pcl_cloud1, *pcl1_colored, {255, 0, 0});
        colorize(*pcl_cloud2, *pcl2_colored, {0, 255, 0});
        colorize(*aligned_cloud, *align_colored, {0, 0, 255});
